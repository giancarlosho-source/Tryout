...
const HELP = {
  title: "Measurements Station",
  description: "Record each player's physical measurements before evaluations begin.",
  steps: [
    { step: 1, text: "Search for the player by name or jersey number." },
    { step: 2, text: "Tap their name to open the measurement form." },
    { step: 3, text: "Enter Height, Standing Reach, and Vertical Jump in inches." },
    { step: 4, text: "Tap Save Measurements. The app returns to search automatically." },
  ],
  tips: [
    "All values are in inches. Height 72 = 6'0\", height 66 = 5'6\".",
    "Players with a red exclamation mark are missing one or more measurements.",
    "You can update measurements later — just search for the player again and save new values.",
    "Standing reach: player stands flat-footed and reaches as high as possible with one arm.",
  ],
};
...
export default function MeasurementsStation() {
  ...
  return (
    <StationShell title="Measurements" color="bg-orange-600" actions={<HelpButton {...HELP} />}>
