...
const HELP = {
  title: "Photo Station",
  description: "Capture a headshot for each player so coaches can put a face to the jersey number.",
  steps: [
    { step: 1, text: "Type the player's name or jersey number to find them." },
    { step: 2, text: "Tap the player's name to select them." },
    { step: 3, text: "Tap Take Photo — this opens the iPad camera or file picker." },
    { step: 4, text: "Take the photo. It saves automatically and returns to search." },
  ],
  tips: [
    "Ask the player to face forward with their jersey number visible for the best result.",
    "If a player already has a photo, a small thumbnail shows in the list. You can retake it anytime.",
    "Photos are stored on the server and visible to coaches in the admin console.",
  ],
};
...
export default function PhotoStation() {
  ...
  return (
    <StationShell title="Photo" color="bg-blue-600" actions={<HelpButton {...HELP} />}>
