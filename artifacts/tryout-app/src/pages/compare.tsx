...
const POSITION_COLORS2: Record<string, string> = {
  Setter: "border-pink-200 bg-pink-50 text-pink-700",
  OutsideHitter: "border-purple-200 bg-purple-50 text-purple-700",
  MiddleBlocker: "border-red-200 bg-red-50 text-red-700",
  Opposite: "border-purple-200 bg-purple-50 text-purple-700",
  Libero: "border-teal-200 bg-teal-50 text-teal-700",
};
